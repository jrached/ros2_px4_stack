...
class SineSweep(BasicMavrosInterface):
    def __init__(
        self,
        node_name: str = "offboard_sine_sweep",
    ...
    def _pack_into_traj_gen(self, vel_x, altitude):
    ...
    def track_sine_sweep(self, sine_sweep, altitude=1.5):
        ...
        while rclpy.ok():
            if flight_state == "TAKEOFF":
                ...
                # Read sine sweep message
                while sine_sweep:
                    self.trajectory_setpoint = self._pack_into_traj_gen(sine_sweep.pop(0), altitude)

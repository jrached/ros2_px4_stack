...
if __name__ == "__main__":
    ...
    commands = [
        ...
        f"sleep 30.0 && source ~/code/dynus_ws/install/setup.bash && cd ~/code/data/bags && rm -rf rosbag* && ros2 bag record PX01/mavros/local_position/pose PX02/mavros/local_position/pose PX03/mavros/local_position/pose BD01/mavros/local_position/pose BD02/mavros/local_position/pose", # Pane 9

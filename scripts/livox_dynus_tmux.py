...
if __name__ == "__main__":
    ...
    commands = [
        ...
        f"sleep 30.0 && source ~/code/dynus_ws/install/setup.bash && cd ~/code/data/bags && rm -rf rosbag* && ros2 bag record PX01/traj PX02/traj PX03/traj BD01/traj BD02/traj", # Pane 9
